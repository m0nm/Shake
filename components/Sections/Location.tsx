...
function LocateUs() {
  return (
    <section
      id="locate-us"
      className="p-3 md:p-10 mt-20 w-full min-h-screen flex flex-col md:flex-row justify-center items-center gap-14 bg-[#FFEDF1]"
    >
      <div className="w-full md:w-1/2 h-full">
        ...
        <div className="h-1/2 w-full">
          <div className="h-[220px] w-full grid grid-cols-4 gap-4">
          ...
          <div className="h-[190px] w-ful grid grid-cols-6 gap-4 mt-8">
            <div className="col-span-2 relative card">
              <Image
                src={store4}
                alt=""
